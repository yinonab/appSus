...
export function FilterSide({
  toggleShowNotDeletedOrArchived,
  toggleShowDeleted,
  toggleShowArchived,
}) {
  const buttonStyle = {
  ...
  const iconStyle = {
    marginRight: "30px", // Adjust this value to add space between SVG and text
  };

  return (
    <div className="filter-side">
      <button onClick={toggleShowNotDeletedOrArchived} style={buttonStyle}>
        <div style={iconStyle}>
          <svg
      ...
      <button onClick={toggleShowDeleted} style={buttonStyle}>
        <div style={iconStyle}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
      ...
      <button onClick={toggleShowArchived} style={buttonStyle}>
        <div style={iconStyle}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
